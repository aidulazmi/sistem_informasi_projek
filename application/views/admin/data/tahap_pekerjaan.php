					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
								<h1 class="d-flex text-white fw-bolder my-1 fs-3">Tahap Pekerjaan</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-white opacity-75">Tahap Pekerjaan</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
											...
											<div class="modal-dialog modal-dialog-centered mw-650px">
												...
												<div class="modal-content">
													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														<!--begin::Form-->
														<form method="post" id="kt_modal_add_user_form" class="form" action="<?php echo site_url('C_admin/simpan_tahap_pekerjaan')?>">
															<!--begin::Scroll-->
															<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																...
																<div class="fv-row mb-7">
																	<!--begin::Label-->
																	<label class="required fw-bold fs-6 mb-2">Nama Tahap Pekerjaan</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="nama_tahap_pekerjaan" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Jenis Pekerjaan"/>
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="satuan" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Jenis Pekerjaan"/>
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row mb-7">
																	<!--begin::Label-->
																	<label class="required fw-bold fs-6 mb-2">Volume Kontrak</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="volume_kontrak" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Jenis Pekerjaan" onkeypress="return event.charCode >= 48 && event.charCode <=57"/>
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="harga_satuan" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Jenis Pekerjaan" onkeypress="return event.charCode >= 48 && event.charCode <=57"/>
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px">Nama Tahap Pekerjaan</th>
												<th class="min-w-125px">Satuan</th>
												<th class="min-w-125px">Volume Kontrak</th>
										...
										<tbody class="text-gray-600 fw-bold">
											...
											<tr>
												...
												<td>
													<?php echo $u->nama_tahap_pekerjaan?>
												</td>
												<td>
													<?php echo $u->satuan?>
												</td>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="<?php echo site_url('C_admin/hapus_tahap_pekerjaan/'.$u->kode_tahap_pekerjaan);?>" class="menu-link px-3" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Delete</a>
														</div>
													</div>
													<!--end::Menu-->
												</td>
